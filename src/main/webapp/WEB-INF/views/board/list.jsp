...
<title>${empty pt.criteria? 'Review' : 'Review 검색 목록'}</title>
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
				<h1 class="display-4">${empty pt.criteria? 'Review' : 'Review 검색 목록'}</h1>
		</div>
		<header>
						...
						<tbody>
							<c:forEach items="${list}" var="dto">
								<tr>
									...
									<td><a
										href="/board/read/${dto.bno}/${pt.curpage}/${pt.criteria}${empty pt.keyword? '' : '/'}${pt.keyword}">${dto.title}</a></td>
