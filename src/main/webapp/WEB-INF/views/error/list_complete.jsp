...
<body>
	...
	<div class="container">
		...
		<!-- nav bar 사용하여 에러 현재 상태에 따라 출력(COMPLETE) -->
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
  			...
  			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    			<div class="navbar-nav">
					...
					<a class="nav-link" href="/error/list_fixing">FIXING</a>
					<a class="nav-link active" href="/error/list_complete">COMPLETE<span class="sr-only">(current)</span></a>
    			</div>
  			</div>
		</nav>
