  ...
  <div class="jumbotron">
    ...
    <div class="row text-center">
      <div class="col-lg-4">
		...
		<p><img src="../resources/img/shop.png" alt="shop" width="200px" height="200px"></p>
		
        <h2>SHOP</h2>
        <p>꼬꼬댁 꼬꼬</p>
        <p><a class="btn btn-secondary" href="/shop/list">주문 하러가기 &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
      
      
		<p><img src="../resources/img/qna.png" alt="shop" width="200px" height="200px"></p>
				
        <h2>Q&A</h2>
        <p>응답하라 판매자</p>
        <p><a class="btn btn-secondary" href="/qna/list">질문하러 가기 &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
      
      
		<p><img src="../resources/img/review.png" alt="shop" width="200px" height="200px"></p>
				 
        <h2>REVIEW</h2>
        <p>알바 안씀</p>
        <p><a class="btn btn-secondary" href="/board/list">리뷰 적으러가기 &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
      </div>
      </div>
